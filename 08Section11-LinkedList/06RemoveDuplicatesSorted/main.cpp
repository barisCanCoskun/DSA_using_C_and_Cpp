...
int main()
{
    ...
    if(check_sorted(first))
        ...
        std::cout << "Before checking sort order, insert data to list. " << std::endl;

    if(remove_duplicates(first))
        std::cout << "Duplication checked" << std::endl;
    else
        std::cout << "Before removing duplicates, insert data to list. " << std::endl;
